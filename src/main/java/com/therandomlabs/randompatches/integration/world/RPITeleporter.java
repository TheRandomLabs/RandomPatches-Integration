package com.therandomlabs.randompatches.integration.world;
...
public final class RPITeleporter extends Teleporter {
	...
	public static void setTeleporter(Class<? extends Teleporter> teleporterClass) {
		RPITeleporter.teleporterClass = teleporterClass;
	}
}
